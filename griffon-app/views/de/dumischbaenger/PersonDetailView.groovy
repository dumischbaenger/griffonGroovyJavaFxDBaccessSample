...
//        .rgb(17, 119, 255), CornerRadii.EMPTY, Insets.EMPTY)));
      ...
      def obj=model.personModel
      def o1=model.personModel.name()
      def o2=model.personModel.age()
...
//      personAge.textProperty().bindBidirectional(model.personModel.age,new NumberStringConverter())
      Bindings.bindBidirectional(personAge.textProperty(),
        model.personModel.age(),
